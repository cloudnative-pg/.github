[![CloudNativePG](/logo/cloudnativepg-landscape-blue.png)](https://cloudnative-pg.io/)
...
|------------------------------|---------------------------------------------|--------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Community/Developers meeting | Every third Thursday, 4PM CET/CEST  | [Zoom](https://zoom-lfx.platform.linuxfoundation.org/meetings/cloudnativepg?view=week&occurrence=1746626400) | [Agenda/minutes](https://notes.cncf.io/IKJxyuSsQnWkIqu7DnjFaA), [Calendar](https://zoom-lfx.platform.linuxfoundation.org/meetings/cloudnativepg) |
| Office Hours meeting         | Every third Wednesday, 4PM CET/CEST | [Calendar](https://zoom-lfx.platform.linuxfoundation.org/meetings/cloudnativepg)                             | It’s a free-form meeting, we can look at problems, discuss PR’s or Issues etc.                                                                                                                                                                   |
